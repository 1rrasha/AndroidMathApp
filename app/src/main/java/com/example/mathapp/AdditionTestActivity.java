...
public class AdditionTestActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if (selectedOptionId != -1) {
                    ...
                    if (currentQuestion.getCorrectAnswer().equals(selectedOption)) {
                        ...
                        Toast.makeText(AdditionTestActivity.this, "Incorrect!", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    Toast.makeText(AdditionTestActivity.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void showFinalScore() {
        Toast.makeText(AdditionTestActivity.this, "Final Score: " + score, Toast.LENGTH_SHORT).show();
        // Reset question count and score for the next test
        questionCount = 0;
        score = 0;

        // Create an intent to navigate back to the previous activity
        Intent intent = new Intent(AdditionTestActivity.this, WelcomeActivity.class);
